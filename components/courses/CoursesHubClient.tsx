...
import { Course } from "@/registry/courses";
import SafeImage from "@/components/SafeImage";

interface CoursesHubClientProps {
  courses: Course[];
}

export default function CoursesHubClient({ courses }: CoursesHubClientProps) {
    ...
    <div style={{
      ...
      <div style={{ maxWidth: "850px", margin: "0 auto" }} className="animate-fade-in">
        ...
        <div style={{ fontSize: "0.8rem", color: "var(--text-muted)", marginBottom: "20px", fontFamily: "'Courier New', monospace" }}>
          REGISTERED_COURSES_FOUND: {filteredCourses.length} of {courses.length}
        </div>
